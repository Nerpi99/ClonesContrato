...
const TokenForm = () => {
    ...
    if (name === "" || symbol === "") {
      ...
      try {
        ...
        if (ethereum) {
          ...
          await contract.clonar(name, symbol, decimalSupply, decimals, {
            value: sendValue,
          });
          setLoading(true);
          await checkEvents();
  ...
  const checkEvents = async () => {
    ...
    let filter = contract.filters.newToken(
      null,
      null,
      null,
      myAddress,
  ...
  return (
    <>
    <Container className="container-token">
            ...
            <Grid xs={12} md={6}>
              ...
              <div className="form-inputs">
                ...
                <TextField
                  ...
                  InputProps={{
                    endAdornment: (
                      <HelpIcon explicacion="Set your new token name" />
                    ),
                    startAdornment: (
                      <PersonOutline
                        sx={{
              ...
              <div className="form-inputs">
                <label htmlFor="symbol" style={{ display: "none" }}>
                  Symbol:
                </label>
                <TextField
                  type="text"
                  ...
                  InputProps={{
                    endAdornment: (
                      <HelpIcon explicacion="Set your new token symbol. (ETH, BTC, BSC, ADA, etc..)" />
                    ),
                    startAdornment: (
                      <PhotoSizeSelectActualOutlined
                        sx={{
              ...
              <div className="form-inputs">
                <label htmlFor="supply" style={{ display: "none" }}>
                  Supply:
                </label>
                <TextField
                  type="number"
                  ...
                  name="supply"
                  variant="standard"
                  onChange={(e) => setSupply(e.target.value.toString())}
                  InputProps={{
                    endAdornment: (
                      <HelpIcon explicacion="Select the amount of Tokens you want to create" />
                    ),
                    startAdornment: (
                      <PersonOutline
                        sx={{
              ...
              <div className="form-inputs">
                <label htmlFor="decimals" style={{ display: "none" }}>
                  decimals:
                </label>
                <TextField
                  type="number"
                  ...
                  InputProps={{
                    endAdornment: (
                      <HelpIcon explicacion="Select the amount of decimals you want for your token. Remember that the default is 18 decimals and modifying may cause problems with another applications." />
                    ),
                    startAdornment: (
                      <Numbers
                        sx={{
              ...
              <Button
                ...
                sx={{ marginTop: "1rem", width: "80%", borderRadius: "13px" }}
                onClick={(e) => createNewToken(e)}
              >
                CREATE TOKEN
              </Button>
              <br/>
              <Typography variant="overline" sx={{ marginTop: "1rem" }}>
                *El fee es de {tarifa} {coin} + gas
              </Typography>
              {error && (
              ...
              {noFunds && (
                <Alert sx={{ marginBottom: "2rem" }} severity="error">
                  No tienes los fondos suficientes en MetaMask para realizar la
                  transaccion.
                </Alert>
              )}
            </Grid>
