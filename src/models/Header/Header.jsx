  ...
  return (
    <section className="home-page">
      <Container>
        <Row>
          <Col xl="5" lg="4">
              <div><Typography variant="h1" component="h2" color="primary" sx={{ fontWeight: "700", fontSize: '4rem' }}>Create a Token in less than 1 minute</Typography><HistoryIcon color="secondary" sx={{ width: '4em', height: '3em' }} /></div>
