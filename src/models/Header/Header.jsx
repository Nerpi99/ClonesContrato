  ...
  return (
    <div id="banner">
      <div className="banner-container">
        <div><Typography variant="h1" component="h2" color="primary" sx={{ fontWeight: "700", display: 'inline', fontSize: '4rem' }}>Create a Token in less than 1 minute</Typography><HistoryIcon color="secondary" sx={{ width: '4em', height: '3em' }} /></div>
        <Link to='create-tokens' style={{ marginTop: '2.5rem', marginBottom: '2.5rem' }}><Button variant="contained" startIcon={<StarBorder sx={{ width: '2em', height: '2em' }} />} sx={{ width: '80%', borderRadius: '2em', fontSize: '1.25em' }}>CREATE TOKEN</Button></Link>
        <div>
